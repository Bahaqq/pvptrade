...
const keypairPath = resolve(".anchor", "pvp_trade-program-keypair.json");
...
console.log(`${created ? "Created" : "Using"} local program keypair: ${keypairPath}`);
console.log(`PVP Trade program address: ${programAddress}`);
